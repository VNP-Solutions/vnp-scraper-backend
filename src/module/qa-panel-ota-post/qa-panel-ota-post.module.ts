...
import { QaPanelOtaPostController } from './qa-panel-ota-post.controller';
import { QaPanelOtaPostRepository } from './qa-panel-ota-post.repository';
import { QaPanelOtaPostService } from './qa-panel-ota-post.service';
...
@Module({
  ...
  controllers: [QaPanelOtaPostController],
  providers: [
    QaPanelOtaPostRepository,
    S3UploadService,
    MailService,
    ExternalJwtGuard,
    ...
    Logger,
    {
      provide: 'IQaPanelOtaPostService',
      useClass: QaPanelOtaPostService,
    },
    {
      provide: 'IQaPanelOtaPostRepository',
      useClass: QaPanelOtaPostRepository,
    },
  ],
  exports: ['IQaPanelOtaPostService', 'IQaPanelOtaPostRepository'],
})
export class QaPanelOtaPostModule {}
