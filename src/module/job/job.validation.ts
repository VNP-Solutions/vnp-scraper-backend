...
export const createJobSchema = z.object({
  ...
  portfolio_name: z.string().min(1, 'Portfolio name is required').optional(),
  sub_portfolio_name: z.string().min(1, 'Sub portfolio name is required').optional(),
  property_name: z.string().min(1, 'Property name is required'),
  billing_type: z.string().min(1, 'Billing type is required').optional(),
